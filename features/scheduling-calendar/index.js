 ...
 * Path   : /features/scheduling-calendar/index.js
 * CSS    : Shared scaffold styles in /css/components.css
 *          Add /features/scheduling-calendar/scheduling-calendar.css when implementing.
 */
...
export function render(container) {
  ...
  container.querySelector('#primary-action-btn')
    ?.addEventListener('click', () =>
      showToast('Scheduling & Calendar — implementation coming soon.', 'info')
    );
}
...
function buildShell() {
  ...
  <div class="section-header">
    <div>
      <div class="section-title">Scheduling & Calendar</div>
      <div class="section-subtitle">Manage staff schedules, shifts, client appointments, and organization-wide events.</div>
    </div>
  ...
  <div class="scaffold-wrapper">
    ...
    <div class="scaffold-hero">
      <div class="scaffold-icon"
           style="background:#D4F8F6;border-color:#0F7A7540">📅</div>
      <div class="scaffold-title">Scheduling & Calendar</div>
      <div class="scaffold-desc">Manage staff schedules, shifts, client appointments, and organization-wide events.</div>
    </div>
    ...
    <div class="scaffold-badge">
      ...
      Assign to <code>/features/scheduling-calendar/</code>
    </div>
