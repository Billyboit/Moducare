 ...
 * Path   : /features/communications/index.js
...
export function render(container) {
  ...
  container.querySelector('#primary-action-btn')
    ?.addEventListener('click', () =>
      showToast('Communications — implementation coming soon.', 'info')
    );
}
...
function buildShell() {
  ...
  <div class="section-header">
    <div>
      ...
      <div class="section-subtitle">Internal messaging, announcements, and department-wide notifications across the organization.</div>
    </div>
  ...
  <div class="scaffold-wrapper">
    ...
    <div class="scaffold-hero">
      <div class="scaffold-icon"
           style="background:#F3E8FF;border-color:#7C3AED40">💬</div>
      <div class="scaffold-title">Communications</div>
      <div class="scaffold-desc">Internal messaging, announcements, and department-wide notifications across the organization.</div>
    </div>
    ...
    <div class="scaffold-badge">
      ...
      Assign to <code>/features/communications/</code>
    </div>
