/**
 * ModuCare MS — Client Portal Module
 * Status : 🔲 Scaffolded — ready for implementation
 * Path   : /features/client-portal/index.js
 * CSS    : Shared scaffold styles in /css/components.css
 *          Add /features/client-portal/client-portal.css when implementing.
 */
...
export function render(container) {
  ...
  container.querySelector('#primary-action-btn')
    ?.addEventListener('click', () =>
      showToast('Client Portal — implementation coming soon.', 'info')
    );
}
...
function buildShell() {
  ...
  <div class="section-header">
    <div>
      ...
      <div class="section-subtitle">External-facing interface for client records, service agreements, and communication history.</div>
    </div>
  ...
  <div class="scaffold-wrapper">
    ...
    <div class="scaffold-hero">
      <div class="scaffold-icon"
           style="background:#E0F2FE;border-color:#0EA5E940">🌐</div>
      <div class="scaffold-title">Client Portal</div>
      <div class="scaffold-desc">External-facing interface for client records, service agreements, and communication history.</div>
    </div>
    ...
    <div class="scaffold-badge">
      ...
      Assign to <code>/features/client-portal/</code>
    </div>
